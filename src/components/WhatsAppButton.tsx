...
export default function WhatsAppButton() {
  const phoneNumber = "918750604476"; // WhatsApp number in international format without + or spaces
  const defaultMessage = "Hello! I'm interested in your premium footwear collection.";
